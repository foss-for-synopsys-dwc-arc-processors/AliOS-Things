...
NISM_BOARD_FLAGS := $(NSIM_STACK_CHECK) $(TOOLCHAIN_DEF) -DBOARD_NSIM -DCURRENT_CORE=arcem -DEMBARC_TCF_GENERATED -DHW_VERSION=10 -DLIB_CLIB -DLIB_CONSOLE -D_HEAPSIZE=8192 -D_HOSTLINK_ -D_NSIM_ -D_STACKSIZE=2048 -D__MW__
