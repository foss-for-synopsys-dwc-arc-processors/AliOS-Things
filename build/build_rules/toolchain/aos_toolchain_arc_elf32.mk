...
ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS   = $(1) -Wall -Wfatal-errors -Wno-error=format -Wno-error=incompatible-pointer-types -fsigned-char -ffunction-sections -fdata-sections -fno-common -mno-sdata -std=gnu99
ADD_COMPILER_SPECIFIC_STANDARD_CXXFLAGS = $(1) -Wall -Wfatal-errors -Wno-error=format -Wno-error=incompatible-pointer-types -fsigned-char -ffunction-sections -fdata-sections -fno-common -mno-sdata -fno-rtti -fno-exceptions
